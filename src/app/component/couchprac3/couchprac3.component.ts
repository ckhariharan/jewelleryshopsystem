...
@Component({
  selector: 'app-couchprac3',
  templateUrl: './couchprac3.component.html',
  styleUrls: ['./couchprac3.component.css']
})
export class Couchprac3Component {
  inputname: any = "hari";
