...
@Component({
  selector: 'app-couchprac14',
  templateUrl: './couchprac14.component.html',
  styleUrls: ['./couchprac14.component.css']
})
export class Couchprac14Component {
