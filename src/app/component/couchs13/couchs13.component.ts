...
@Component({
  selector: 'app-couchs13',
  templateUrl: './couchs13.component.html',
  styleUrls: ['./couchs13.component.css']
})
export class Couchs13Component {
  @Input()
  ...
  public employeeFormGroup = this.fb.group({
    ...
    'product': ['Double Heart Drop Earring'],
    'amount': [2100],
    'amount1': ['2,100₹'],
    'balance': [],
    'percent': [20],
