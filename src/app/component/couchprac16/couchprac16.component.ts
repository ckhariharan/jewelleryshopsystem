...
@Component({
  selector: 'app-couchprac16',
  templateUrl: './couchprac16.component.html',
  styleUrls: ['./couchprac16.component.css']
})
export class Couchprac16Component {
