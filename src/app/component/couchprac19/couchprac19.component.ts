...
@Component({
  selector: 'app-couchprac19',
  templateUrl: './couchprac19.component.html',
  styleUrls: ['./couchprac19.component.css']
})
export class Couchprac19Component {
  ...
  public employeeFormGroup = this.fb.group({
    ...
    'product': ['Round Cut Grown Diamond'],
    'amount': [31100],
    'amount1': ['31,100₹'],
    'balance': [],
    'percent': [60],
  ...
  saveAction() {
    if (!this.employeeFormGroup.valid) {
      Swal.fire('Error', 'Please Fill All Boxes', 'error');
    } else {
