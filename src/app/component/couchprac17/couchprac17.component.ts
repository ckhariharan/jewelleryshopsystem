...
@Component({
  selector: 'app-couchprac17',
  templateUrl: './couchprac17.component.html',
  styleUrls: ['./couchprac17.component.css']
})
export class Couchprac17Component {
  @Input()
