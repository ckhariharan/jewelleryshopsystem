...
@Component({
  selector: 'app-couchprac10',
  templateUrl: './couchprac10.component.html',
  styleUrls: ['./couchprac10.component.css']
})
export class Couchprac10Component {
  @Input()
