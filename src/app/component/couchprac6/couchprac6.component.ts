...
@Component({
  selector: 'app-couchprac6',
  templateUrl: './couchprac6.component.html',
  styleUrls: ['./couchprac6.component.css']
})
export class Couchprac6Component {
  inputname: any = "hari";
