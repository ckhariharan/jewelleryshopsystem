...
@Component({
  selector: 'app-couchprac18',
  templateUrl: './couchprac18.component.html',
  styleUrls: ['./couchprac18.component.css']
})
export class Couchprac18Component {
