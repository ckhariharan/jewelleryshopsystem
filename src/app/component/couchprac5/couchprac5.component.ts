...
@Component({
  selector: 'app-couchprac5',
  templateUrl: './couchprac5.component.html',
  styleUrls: ['./couchprac5.component.css']
})
export class Couchprac5Component {
  inputname: any = "hari";
