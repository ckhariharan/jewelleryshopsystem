...
@Component({
  selector: 'app-couchprac9',
  templateUrl: './couchprac9.component.html',
  styleUrls: ['./couchprac9.component.css']
})
export class Couchprac9Component { 
