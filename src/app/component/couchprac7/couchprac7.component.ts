...
@Component({
  selector: 'app-couchprac7',
  templateUrl: './couchprac7.component.html',
  styleUrls: ['./couchprac7.component.css']
})
export class Couchprac7Component {
  inputname: any = "hari";
  @Input()
