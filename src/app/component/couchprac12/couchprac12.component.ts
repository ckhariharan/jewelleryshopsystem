...
@Component({
  selector: 'app-couchprac12',
  templateUrl: './couchprac12.component.html',
  styleUrls: ['./couchprac12.component.css']
})
export class Couchprac12Component {
