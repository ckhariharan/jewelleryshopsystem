...
@Component({
  selector: 'app-couchprac4',
  templateUrl: './couchprac4.component.html',
  styleUrls: ['./couchprac4.component.css']
})
export class Couchprac4Component {
  inputname:any="hari";
@Input()
