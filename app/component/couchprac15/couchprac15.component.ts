...
@Component({
  selector: 'app-couchprac15',
  templateUrl: './couchprac15.component.html',
  styleUrls: ['./couchprac15.component.css']
})
export class Couchprac15Component {
 ...
 'product':['Intertined glim diamond'],
amount :[41300],
'amount1':['41,300₹'],
